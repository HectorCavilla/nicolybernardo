    ...
    children: (
      <div className="absolute inset-0 flex items-center justify-center flex-col z-10 p-4">
        ...
        <div className={`w-full md:w-3/6 flex justify-center items-center flex-row text-white mt-0 md:mt-5`}>
          <div ref={ref} className={`${isVisible ? "animate-jump-in animate-delay-500 " : ""}flex justify-center items-center flex-col bg-accent/80 float-left text-center px-6 py-5 md:py-0 md:!px-20 md:!pt-7 md:!pb-3 rounded mx-2 md:!mx-2`}>
            <div className={`text-5xl md:leading-[.6]`}>{days}</div>
            <span className={`text-lg font-light`}>Días</span>
          </div>
          <div className={`flex justify-center items-center flex-col bg-accent/80 float-left text-center px-6 py-5 md:py-0 md:!px-20 md:!pt-7 md:!pb-3 rounded mx-2 md:!mx-2`}>
  ...
  return (
    <section className="relative w-full h-[60vh] min-h-[500px] overflow-hidden">
      <ParallaxBanner
        layers={[
          {
            image: '/nicol-y-bernardo/hugo-judith.webp', // New background image
            translateY: [-20, 20],
            opacity: [1, 1],
            shouldAlwaysCompleteAnimation: true
          },
          {
            children: <div className="absolute inset-0 bg-black/50" /> // Dark overlay
          },
          counter
        ]}
